...
/**
 * check_elf - tasked to check if a file is an ELF file.
...
/**
 * print_abi - it prrints the ABI version of an ELF header.
...
/**
 * main - it displays the information contained in the ELF header at the start of an ELF file.
